...
public class SingleStock_Impl implements SingleStock_service {
    ...
    public ArrayList<StockVO> Show(String id) throws ParseException {
        ...
        return this.setTime(id, date1, date2);
    ...
    public ArrayList<StockVO> setTime(String id, String startTime, String endTime) throws ParseException {
        ...
        Date every = new Date();
        Date line = sdf.parse("2010-01-01");
	...
	public static void main(String[] args) throws ParseException {
		...
		ArrayList<StockVO> res = test.setTime("sz002644", "2016-02-03", "2016-02-23");
