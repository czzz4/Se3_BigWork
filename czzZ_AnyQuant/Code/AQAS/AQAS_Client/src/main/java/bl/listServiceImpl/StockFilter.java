...
public class StockFilter {
    ...
    private StockVO low;
    private StockVO high;
    private StockVO curr;

    StockFilter(StockVO low, StockVO high, StockVO curr) {
        this.low = low;
        this.high = high;
        this.curr = curr;
...
//		System.out.println("filt adj");
        ...
        BigDecimal lowAdj = new BigDecimal(low.getAdj());
        BigDecimal highAdj = new BigDecimal(high.getAdj());
        BigDecimal currAdj = new BigDecimal(curr.getAdj());
        if (low.getAdj() != -1 && high.getAdj() != -1) {
